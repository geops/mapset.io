...
const trClassName = "even:bg-white odd:bg-blue-lighter flex gap-6 justify-center !bg-transparent";
...
function AnnualPromo() {
  ...
  return (
    <div className="pointer-events-none">
      <svg className="absolute right-10 top-[-20px] sm:right-[-20px] sm:top-[-10px]" width="49" height="28" viewBox="0 0 49 28" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          {products.map((product) => {
            return (
              <div key={product.tier} className="sm:basis-1/4 w-full sm:w-auto text-center rounded-2xl p-6 text-blue-700 border border-[#8FCCFE] bg-[#F1F9FE]">
                <p className={`mb-3 text-sm font-medium	${inter.className}`}>{product.tier}</p>
